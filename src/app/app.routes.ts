...
export const routes: Routes = [
  ...
  },
  {
    ...
    loadComponent: () =>
      import('./auth/oauth-verification/oauth-verification.component').then(
        (m) => m.OAuthVerificationComponent,
      ),
  },
  {
  ...
  },
  {
    path: 'admin/users',
    loadComponent: () =>
      import('./admin/users-management/users-management.component').then(
  ...
  },
  {
    ...
    loadComponent: () =>
      import('./admin/edit-home-page/edit-home-page.component').then(
        (m) => m.EditHomePageComponent,
      ),
    canActivate: [adminGuard],
  },
  {
    ...
    loadComponent: () =>
      import('./admin/money-requests/money-requests.component').then(
        (m) => m.MoneyRequestsComponent,
      ),
    canActivate: [adminGuard],
  },
  {
    ...
    loadComponent: () =>
      import('./admin/customer-feedback/customer-feedback.component').then(
        (m) => m.CustomerFeedbackComponent,
      ),
    canActivate: [adminGuard],
  },
  {
    ...
    loadComponent: () =>
      import('./admin/job-applications/job-applications.component').then(
  ...
  },
  {
    ...
    loadComponent: () =>
      import('./admin/auction-products/auction-products.component').then(
        (m) => m.AuctionProductsComponent,
      ),
    canActivate: [adminGuard],
  },
  {
    ...
    loadComponent: () =>
      import('./admin/auctions-management/auctions-management.component').then(
        (m) => m.AuctionsManagementComponent,
      ),
    canActivate: [adminGuard],
  },
  {
    ...
    loadComponent: () =>
      import('./admin/send-messages/send-messages.component').then((m) => m.SendMessagesComponent),
    canActivate: [adminGuard],
  },
  {
    path: 'profile',
  ...
  },
  {
    path: 'auctions/:id',
    loadComponent: () =>
      import('./auctions/auction-details/auction-details.component').then(
        (m) => m.AuctionDetailsComponent,
      ),
  },
  {
    path: 'cart',
